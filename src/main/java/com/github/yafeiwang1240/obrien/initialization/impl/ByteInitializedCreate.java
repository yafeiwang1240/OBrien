...
import com.github.yafeiwang1240.obrien.initialization.annotation.InitializedByte;

import java.util.List;
import java.util.Map;

public class ByteInitializedCreate extends AbstractInitializedCreate<InitializedByte> {

    public ByteInitializedCreate(InitializedByte annotation) {
        super(annotation);
    }
